...
create table tasks (
  ...
  specific_date date,                  -- if set, this task applies to ONE exact date only, overriding days
...
create table spelling_lists (
  ...
  words text[] not null,
  sentences text[] not null default '{}',  -- sentences[i] gives context for words[i], disambiguates homophones
